...
property[1] = "Currency";
unit[1] = new Array("Dollar (USD)", "European (Euro)", "Indian Rupees (INR)", "Japanese Yen (JPY)", "Russian Ruble (RUB)", "Pound Sterling (GBP)", "Canadian Dollar (CAD)", "Mexican Peso(MXN)", "Chinese Yuan (CNY)", "South Korean Won (KRW)");
currenycodes = new Array("USD", "EUR", "INR", "JPY", "RUB", "GBP", "CAD", "MXN", "CNY", "KRW");

property[2] = "Area";
unit[2] = new Array("Square meter (m²)", "Acre (acre)", "Hectare", "Square centimeter (cm²)", "Square kilometer (km²)", "Square foot (ft²)", "Square inch (in²)", "Square mile (mi²)", "Square yard (yd²)");
factor[2] = new Array(1, 4046.856, 10000, 0.0001, 1000000, 9.290304E-02, 6.4516E-04, 2589988, 0.8361274);

property[3] = "Mass";
unit[3] = new Array("Kilogram (kg)", "Gram (g)", "Milligram (mg)", "Microgram (µ-g)", "Ton");
factor[3] = new Array(1, 0.001, 1e-6, 0.000000001, 1000);

property[4] = "Velocity";
unit[4] = new Array("Meter/second (m/sec)", "Foot/minute (ft/min)", "Foot/second (ft/sec)", "Kilometer/hour (km/h)", "Mile/hour (mph)", "Speed of light (c)");
factor[4] = new Array(1, 5.08E-03, 0.3048, 0.2777778, 0.44707, 299792458);

property[5] = "Acceleration";
unit[5] = new Array("Meter/sq.sec (m/sec²)", "Foot/sq.sec (ft/sec²)", "Gravitational constant (g)", "Inch/sq.sec (in/sec²)");
factor[5] = new Array(1, .3048, 9.806650, 2.54E-02);

property[6] = "Electricity";
unit[6] = new Array("Coulomb (Cb)", "Abcoulomb", "Ampere hour (A hr)", "Faraday (F)", "Statcoulomb", "Millifaraday (mF)", "Microfaraday (mu-F)", "Picofaraday (pF)");
factor[6] = new Array(1, 10, 3600, 96521.8999999997, .000000000333564, 96.5219, 9.65219E-02, 9.65219E-05);

property[7] = "Energy";
unit[7] = new Array("Joule (J)", "BTU (mean)", "BTU (thermochemical)", "Calorie (SI) (cal)", "Calorie (mean)(cal)", "Calorie (thermo)", "Electron volt (eV)", "Erg (erg)", "Foot-pound force", "Foot-poundal", "Horsepower-hour", "Kilocalorie (SI)(kcal)", "Kilocalorie (mean)(kcal)", "Kilowatt-hour (kW hr)", "Ton of TNT", "Volt-coulomb (V Cb)", "Watt-hour (W hr)", "Watt-second (W sec)");
factor[7] = new Array(1, 1055.87, 1054.35, 4.1868, 4.19002, 4.184, 1.6021E-19, .0000001, 1.355818, 4.214011E-02, 2684077.3, 4186.8, 4190.02, 3600000, 4.2E9, 1, 3600, 1);

property[8] = "Force";
unit[8] = new Array("Newton (N)", "Dyne (dy)", "Kilogram force (kgf)", "Kilopond force (kpf)", "Kip (k)", "Ounce force (ozf)", "Pound force (lbf)", "Poundal");
factor[8] = new Array(1, .00001, 9.806650, 9.806650, 4448.222, .2780139, .4535924, .138255);

property[9] = "Power";
unit[9] = new Array("Watt (W)", "Kilowatt (kW)", "Megawatt (MW)", "Milliwatt (mW)", "BTU (SI)/hour", "BTU (thermo)/second", "BTU (thermo)/minute", "BTU (thermo)/hour", "Calorie (thermo)/second", "Calorie (thermo)/minute", "Erg/second", "Foot-pound force/hour", "Foot-pound force/minute", "Foot-pound force/second", "Horsepower(550 ft lbf/s)", "Horsepower (electric)", "Horsepower (boiler)", "Horsepower (metric)", "Horsepower (UK)", "Kilocalorie (thermo)/min", "Kilocalorie (thermo)/sec");
factor[9] = new Array(1, 1000, 1000000, .001, .2930667, 1054.35, 17.5725, .2928751, 4.184, 6.973333E-02, .0000001, .0003766161, .02259697, 1.355818, 745.7, 746, 9809.5, 735.499, 745.7, 69.7333, 4184);

property[10] = "Pressure";
unit[10] = new Array("Newton/sq.meter", "Atmosphere (normal)", "Atmosphere (techinical)", "Bar", "Centimeter mercury(cmHg)", "Centimeter water (4°C)", "Decibar", "Kgr force/sq.centimeter", "Kgr force/sq.meter", "Kip/square inch", "Millibar", "Millimeter mercury(mmHg)", "Pascal (Pa)", "Kilopascal (kPa)", "Megapascal (Mpa)", "Poundal/sq.foot", "Pound-force/sq.foot", "Pound-force/sq.inch (psi)", "Torr (mmHg,0°C)");
factor[10] = new Array(1, 101325, 98066.5, 100000, 1333.22, 98.0638, 10000, 98066.5, 9.80665, 6894757, 100, 133.3224, 1, 1000, 1000000, 47.88026, 47.88026, 6894.757, 133.322);

property[11] = "Temperature";
unit[11] = new Array("Degrees Celsius (°C)", "Degrees Fahrenheit (°F)", "Degrees Kelvin (°K)");
factor[11] = new Array(1, 0.555555555555, 1);
tempIncrement = new Array(0, -32, -273.15);

property[12] = "Time";
unit[12] = new Array("Second (sec)", "Day (mean solar)", "Day (sidereal)", "Hour (mean solar)", "Hour (sidereal)", "Minute (mean solar)", "Minute (sidereal)", "Month (mean calendar)", "Second (sidereal)", "Year (calendar)", "Year (tropical)", "Year (sidereal)");
factor[12] = new Array(1, 8.640E4, 86164.09, 3600, 3590.17, 60, 60, 2628000, .9972696, 31536000, 31556930, 31558150);
...
input1.addEventListener('input', function () {
    const propertyID = document.querySelector("#propertyID");
    if (propertyID.innerText.toUpperCase() == "CURRENCY") {
        ConvertCurrency(1, 2);
    }
    else {
        ConvertFromTo(1, 2);
...
const ConvertCurrency = (source, target) => {
    var inputText;
    var resultText;
    if (source==1) {
        inputText="#inputID";
    ...
    for (let i = 0; i < unit[1].length; i++) {
        str = unit[1][i];
        word = document.querySelector(inputText).innerText;
        if (word == "Select Unit") {
    ...
    for (let i = 0; i < unit[1].length; i++) {
        str = unit[1][i];
        word = document.querySelector(resultText).innerText;
        if (word == "Select Unit") {
    ...
    async function currency() {
            ...
            let sourceValue=document.querySelector(`#input${source}`).value;
            let result=sourceValue*val;
            document.querySelector(`#input${target}`).value=result.toFixed(2);
    }
    currency();
}
